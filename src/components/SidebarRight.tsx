                    ...
                    <div className="space-y-3">
                        {recommendations.length === 0 ? (
                            ...
                            recommendations.map((group) => (
                                <div key={group.id} className="p-3 rounded bg-white/5 hover:bg-white/10 transition-colors border border-white/5 hover:border-primary/30 group cursor-pointer">
                                    <div className="flex justify-between items-start mb-1">
                                        ...
                                        <Badge variant="outline" className="text-[10px] h-5 border-primary/20 text-primary">{group.relevance_score}% Match</Badge>
                                    </div>
